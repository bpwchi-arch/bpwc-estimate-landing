          ...
          <div className="bg-white rounded-xl border-2 border-sky-100 p-6 shadow-sm space-y-5">
            ...
            <div>
              <Label htmlFor="email" className="text-sky-950 font-medium mb-2 block">
                Email Address <span className="text-sky-500 text-xs font-normal">(optional)</span>
              </Label>
              <Input
                id="email"
                type="email"
                ...
                className="h-12 text-base"
              />
              <p className="text-sky-600 text-xs mt-1.5">We'll also send your estimate here if provided</p>
            </div>
